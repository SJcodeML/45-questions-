...
const guest :string[] = ["Aisha" , "Marium" , "Zainab","Misho" , "A.Subha", "Khadija"]
guest.map(invite => {
...
const updatedGuestList: string[] = [newGuest2, ...guest];
console.log(guest)
